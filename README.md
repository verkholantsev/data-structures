...
Хэш-функция должна превращать ключ из пары ключ-значение в индекс массива, в котором хранятся значения. Например, у нас есть массив длиной 5 элементов для хранения значений.
...
При таком подходе в массиве хранятся не ключи, а связанные списки ключей.
